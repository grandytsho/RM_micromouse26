...
![PCB2 Bot](Insert_PCB1_Image_Link_Here)

This is the second of the two almost identical bots we made for the Technoxian 2026 competition. 
It uses an array of **4 IR sensors** situated on the boundary of the maze solver. The orientation of the IR sensors is positioned such that we have maximum area coverage. 
