...
int LEFT_SETPOINT = 729;
int LEFT_MAX = 879;
int RIGHT_SETPOINT = 702;
int RIGHT_MAX = 893;
int LEFT_WALL_THRESHOLD = 424; 
int RIGHT_WALL_THRESHOLD = 324;
int FRONT_WALL_DETECTION_THRESHOLD = 314;
int FRONT2_WALL_DETECTION_THRESHOLD = 394;
int FRONT_WALL_COLLISION_THRESHOLD = 504;
int FRONT2_WALL_COLLISION_THRESHOLD = 533;
