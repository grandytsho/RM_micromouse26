...
int LEFT_SETPOINT = 522;
int LEFT_MAX = 890;
int RIGHT_SETPOINT = 429;
int RIGHT_MAX = 904;
int LEFT_WALL_THRESHOLD = 344; 
int RIGHT_WALL_THRESHOLD = 266;
int FRONT_WALL_DETECTION_THRESHOLD = 270;
int FRONT2_WALL_DETECTION_THRESHOLD = 289;
int FRONT_WALL_COLLISION_THRESHOLD = 320;
int FRONT2_WALL_COLLISION_THRESHOLD = 320;
