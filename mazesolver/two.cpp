...
int LEFT_SETPOINT = 454;
int LEFT_MAX = 880;
int RIGHT_SETPOINT = 504;
int RIGHT_MAX = 930;
int LEFT_WALL_THRESHOLD = 318; 
int RIGHT_WALL_THRESHOLD = 312;
int FRONT_WALL_DETECTION_THRESHOLD = 272;
int FRONT2_WALL_DETECTION_THRESHOLD = 303;
int FRONT_WALL_COLLISION_THRESHOLD = 348;
int FRONT2_WALL_COLLISION_THRESHOLD = 336;
